...
def stats(file_path: str = None) -> None:
    ...
    # Analyze patterns
    print("\n  Username patterns:")
    patterns = {"single_letter": 0, "with_numbers": 0, "short": 0, "long": 0}
...
if __name__ == "__main__":
    ...
    sync_parser.add_argument(
        "--output", default=None, help=f"Output file (default: {USERNAMES_FILE})"
    )

    # Clean command
    clean_parser = subparsers.add_parser(
        "clean", help="Clean duplicates and empty entries"
    )
    clean_parser.add_argument(
        "--file", default=None, help=f"File to clean (default: {USERNAMES_FILE})"
    )
    ...
    check_parser.add_argument(
        "--file", default=None, help=f"File to check (default: {USERNAMES_FILE})"
    )
    ...
    add_parser.add_argument(
        "--file", default=None, help=f"File to update (default: {USERNAMES_FILE})"
    )

    # Stats command
    stats_parser = subparsers.add_parser("stats", help="Show file statistics")
    stats_parser.add_argument(
        "--file", default=None, help=f"File to analyze (default: {USERNAMES_FILE})"
    )
