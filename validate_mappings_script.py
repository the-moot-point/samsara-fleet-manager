...
def validate_mappings(mappings_dir: str = "./mappings") -> bool:
    ...
    never_valid, never_positions = validate_never_positions(
        mappings_path / "never_positions.csv"
    )
...
def cross_validate(
    position_tags: Set[str], location_tags: Set[str], never_positions: Set[str]
) -> bool:
    ...
    try:
        ...
        for hire in test_hires:
            ...
            if is_valid:
                ...
                location_tag, timezone = manager.get_location_info(
                    hire["Location_Desc"]
                )
